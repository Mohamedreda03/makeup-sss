...
var makeup_products_seed_json_1 = __importDefault(require("../makeup-products-seed.json"));
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var hashedPassword, user, i, product, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (!(i < makeup_products_seed_json_1.default.length)) return [3 /*break*/, 6];
                    product = makeup_products_seed_json_1.default[i];
                ...
                case 5:
                    ...
                    return [3 /*break*/, 3];
                case 6:
                    console.log("Seeded ".concat(makeup_products_seed_json_1.default.length, " products from Makeup API"));
                    return [3 /*break*/, 10];
                case 7:
                    error_1 = _a.sent();
